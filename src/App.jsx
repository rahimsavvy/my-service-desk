...
function App() {
  ...
  const defaultArticles = [
    ...
    { id: 21, title: "JAMF Pro Management & Sync", category: "Macintosh HD", content: "Open the Mac Self Service app to manually sync policies and pull down missing software packages." },
    { id: 22, title: "Macbook Password Recovery", category: "Macintosh HD", content: "Shut down the Mac. Press and hold the power button (Apple Silicon) until you see 'Loading startup options', then use the Reset Password utility." },
    { id: 23, title: "Macbook Zero-Touch Enrollment", category: "Macintosh HD", content: "Connect to Wi-Fi during the initial Setup Assistant screen to automatically trigger Apple Business Manager enrollment." },
  ...
  return (
    <div className={`App ${hackerMode ? 'hacker-theme' : ''}`}>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (val.toLowerCase() === "/admin") {
                ...
                alert(hackerMode ? "System Restored." : "Wake up, Neo... Hacker Mode Activated.");
              } else {
                setSearchTerm(val);
              }
            }}
      ...
      {currentPage === 'refreshment' && (
        <section className="container">
          ...
          {!showQuiz ? (
            <div className="category-grid puzzle-4-grid">
        ...
        <section className="container">
          ...
          <div className="category-grid puzzle-4-grid">
            <div className="category-card" onClick={() => alert("Fetching live status dashboard...")}>
              <div className="category-icon"><AlertCircle size={32} /></div>
            ...
            <div className="category-card" onClick={() => alert("Opening maintenance calendar...")}>
              <div className="category-icon"><Calendar size={32} /></div>
            ...
            <div className="category-card" onClick={() => alert("Loading outage history...")}>
              <div className="category-icon"><FileText size={32} /></div>
              <h3>Past Incidents</h3>
              <p>Archive of resolved outages and root cause analysis (RCA).</p>
            </div>

            {/* NEW OUTAGE CARDS */}
            <div className="category-card" onClick={() => alert("Loading vendor status boards...")}>
              <div className="category-icon"><Cloud size={32} /></div>
              <h3>Cloud Providers</h3>
              <p>Check the external status of AWS, Azure, and Google Workspace.</p>
            </div>
            <div className="category-card" onClick={() => alert("Loading uptime metrics...")}>
              <div className="category-icon"><Activity size={32} /></div>
              <h3>Uptime Metrics</h3>
              <p>View historical SLA performance and 99.9% uptime reports.</p>
            </div>
            <div className="category-card" onClick={() => alert("Opening subscription settings...")}>
              <div className="category-icon"><Smartphone size={32} /></div>
              <h3>Alert Subscriptions</h3>
              <p>Sign up for SMS and email notifications during critical P1 outages.</p>
            </div>
          </div>
          <button className="back-btn" onClick={() => navigateTo('home')}>← Back to Knowledge Base</button>
        </section>
